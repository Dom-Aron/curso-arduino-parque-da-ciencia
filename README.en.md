...
| Lesson 06 | `aula-06-speed_of_sound-ArduinoIDE` | Speed of sound | Time measurements, distance, sound propagation, and experimental estimation |
| Lesson 07 | `aula-07-driver-ArduinoIDE` | Transistor and relay driver | Load switching, BC548 transistor, relay, protection diode, and base current |
| Lesson 08 | `aula-08-lcd_display-ArduinoIDE` | LCD display | I2C interface, text, custom characters, and animations |
| Lesson 09 | `aula-09-stopwatch-ArduinoIDE` | Stopwatch | Time measurements, buttons, LCD I2C, and state organization |
| Lesson 10 | `aula-10-gravitational_acceleration-ArduinoIDE` | Gravitational acceleration | Free fall, sensors, time measurements, and estimation of g |
