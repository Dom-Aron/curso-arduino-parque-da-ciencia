 ...
 * Caminho no repositório: aulas/ArduinoIDE/aula-07-driver-ArduinoIDE/aula-07-driver-ArduinoIDE.ino
 * Data da última revisão: 29/04/2026
 *
 * Descrição:
 *   ============================================================
 *   Projeto   : Aula 07 - Driver
 *   Arquivo   : aula-07-driver-ArduinoIDE.ino
 *   Pasta     : aula-07-driver-ArduinoIDE
