 ...
 * Caminho no repositório: aulas/ArduinoIDE/aula-06-speed_of_sound-ArduinoIDE/aula-06-speed_of_sound-ArduinoIDE.ino
 * Data da última revisão: 29/04/2026
 *
 * Descrição:
 *   ============================================================
 *   Projeto   : Aula 06 - Speed of Sound
 *   Arquivo   : aula-06-speed_of_sound-ArduinoIDE.ino
 *   Pasta     : aula-06-speed_of_sound-ArduinoIDE
