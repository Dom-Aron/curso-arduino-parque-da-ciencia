 ...
 * Plataforma: Arduino
 * Ambiente alvo: VS Code + Arduino Community Edition + serial-plotter
 ...
 *   Arquivo   : aula-04-zero_law_two_lm35_VSCode_isolated.ino
 *
 ...
 *
 *   O serial-plotter do VS Code recebe, para cada sensor:
